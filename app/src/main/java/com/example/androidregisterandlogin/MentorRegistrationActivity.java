...
public class MentorRegistrationActivity extends AppCompatActivity implements ValidationInterface {

    private EditText et_name, et_email, et_password, et_c_password;
    private String name,email,password,c_password;
    private Button btn_regist;
    private ProgressBar loading;
    private static String URL_REGIST = "http://192.168.10.102:8888/mentordai/mentorregister.php";
        ...
        btn_regist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(check_validation()){
                    ...
                    Toast.makeText(MentorRegistrationActivity.this,"Validation failed ", Toast.LENGTH_SHORT).show();
                }
            }
        });
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try{
                            ...
                            if (success.equals("1")) {
                                Toast.makeText(MentorRegistrationActivity.this, "Register Success!", Toast.LENGTH_SHORT).show();
                                btn_regist.setVisibility(View.VISIBLE);
                            }else if(success.equals("2")){
                                Toast.makeText(MentorRegistrationActivity.this, "Please verify your password", Toast.LENGTH_SHORT).show();
                                btn_regist.setVisibility(View.VISIBLE);
                            }
//
...
//                            }
                            ...
                            e.printStackTrace();
                            Toast.makeText(MentorRegistrationActivity.this, "Register Error! " + e.toString(), Toast.LENGTH_SHORT).show();
                            loading.setVisibility(View.GONE);
                            btn_regist.setVisibility(View.VISIBLE);
                        }
                    }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(MentorRegistrationActivity.this, "Register Error! " + error.toString(), Toast.LENGTH_SHORT).show();
                        loading.setVisibility(View.GONE);
                        btn_regist.setVisibility(View.VISIBLE);
                    }
                })
